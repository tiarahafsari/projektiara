...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container">
            <a class="navbar-brand" href="index.php">Tiara Galleri</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav me-auto">
                    ...
                    ?>
                        <a href="register.php" class="btn btn-outline-secondary m-1">Register</a>
                        <a href="login.php" class="btn btn-outline-secondary m-1">Login</a>
                    <?php
                    } else {
                    ?>
                        <li class="nav-item">
